...
def build_dataset(args, rank = 0):
    ...
    rec_feat_db = ImageFeaturesDB(args.rec_img_ft_file, args.image_feat_size)
    ...
    train_env = dataset_class(
        view_db = feat_db, rec_view_db = rec_feat_db, ins2img_db = ins2img_db, obj_db = obj_db, instr_data = train_instr_data,
    ...
    for split in val_env_names:
        ...
        val_env = dataset_class(
            view_db = feat_db, rec_view_db = rec_feat_db, ins2img_db = ins2img_db, obj_db = obj_db, instr_data = val_instr_data,
            connectivity_dir = args.connectivity_dir, obj2vps = obj2vps,
